...
import com.example.jimjam.databinding.ActivityCardChestTricepBinding

class CardChestTricep : AppCompatActivity() {
    private lateinit var binding: ActivityCardChestTricepBinding
    private val totalExercises = 6 // Update this if you add or remove exercises

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityCardChestTricepBinding.inflate(layoutInflater)
